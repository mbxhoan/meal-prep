...
> = {
  ...
  combos: lookupConfig("combos", {
    ...
    select:
      "id, shop_id, code, name, sale_price, default_sale_price, total_cost, gross_profit, gross_margin, notes, is_active, deleted_at, created_at, updated_at",
    orderBy: { column: "updated_at", ascending: false },
    fields: [
      { name: "code", label: "Mã combo", type: "text", required: true },
      { name: "name", label: "Tên combo", type: "text", required: true },
      {
        name: "sale_price",
        label: "Giá bán combo",
        type: "number",
      ...
      { name: "notes", label: "Ghi chú", type: "textarea" },
      { name: "is_active", label: "Đang hoạt động", type: "checkbox", defaultValue: true },
    ],
    columns: [
      { key: "code", label: "Mã" },
      { key: "name", label: "Tên" },
      { key: "sale_price", label: "Giá bán", type: "money" },
      { key: "default_sale_price", label: "Giá mặc định", type: "money" },
      { key: "total_cost", label: "Giá vốn", type: "money" },
      { key: "gross_profit", label: "Lãi", type: "money" },
      { key: "gross_margin", label: "Tỷ lệ lãi", type: "percent" },
      { key: "is_active", label: "Trạng thái", type: "boolean" },
    ],
    searchFields: ["code", "name", "notes"],
    optionLabelPaths: ["code", "name"],
