        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="min-w-0 max-w-3xl">
            ...
            <p className="mt-1 text-sm leading-6 text-slate-500">
              Nguồn sự thật cho khách hàng, nhà cung cấp, kho, hàng hóa, thực đơn
              và bảng giá.
            </p>
          </div>
      ...
      <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
        {entities.map((entity) => (
          <Link
            ...
            className="rounded-[24px] border border-white/70 bg-white/90 p-4 shadow-[0_20px_80px_-40px_rgba(15,23,42,0.45)] transition hover:-translate-y-0.5 hover:border-[#d6decf]"
          >
